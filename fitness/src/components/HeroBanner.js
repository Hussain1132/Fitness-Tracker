...
const HeroBanner = () => {
  return (
    <Box sx={{mt:{lg:'212px',xs:'70px'},ml:{sm:'50px'}}} position='relative' p='20px'>
      ...
      <Typography  fontSize='24px' lineHeight='35px' mb={4} >Check out the most effective exercises</Typography>
      <Typography fontWeight='600' color='#ff2625' sx={{opacity:0.1,display:{lg:'block',xs:'none'}}} fontSize='190px'>Stay Fit</Typography>
